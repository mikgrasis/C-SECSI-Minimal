...
% KRP   Khatri-Rao (column-wise Kronecker) product of two matrices.
%
%   C = KRP(A,B) returns the Khatri-Rao product of A and B. The input
...
%    Jan 2019: Improved speed (using bsx)

if size(A, 2) ~= size(B, 2)
    error('Khatri-Rao product requires two matrices with equal number of columns.');
end
